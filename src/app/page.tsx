...
export default function Home() {
  ...
  const handleSubmit = () =>{
    ...
    settodos(newTodos);
    settodo("");
    localStorage.setItem("todos", JSON.stringify(newTodos)); // ذخیره در مرورگر
  };
...
<div>
  {todos.map((t, i)=> (
    ...
    <div key={i} className="p-3 hover:bg-gray-200 mb-2 border border-gray-400 rounded-xl ml-10 mr-10 bg-green-100 ">
      {t}
